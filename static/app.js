...
async function fetchAllData() {
    try {
        ...
        try {
            const deliRes = await fetch(`${API_BASE_URL}/delis`);
...
function showToast(message) {
    ...
    toast.className = "fixed bottom-5 left-1/2 transform -translate-x-1/2 bg-gray-900 text-white text-xs px-4 py-2 rounded-full shadow-lg z-50 transition-all opacity-9 الخ";
